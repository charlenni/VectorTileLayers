...
{
    public class MGLSprite : Sprite
    {
        public MGLSprite(KeyValuePair<string, Json.JsonSprite> sprite, int atlasId) : base(atlasId, sprite.Value.X, sprite.Value.Y, sprite.Value.Width, sprite.Value.Height, sprite.Value.PixelRatio)
        {
            Name = sprite.Key;
