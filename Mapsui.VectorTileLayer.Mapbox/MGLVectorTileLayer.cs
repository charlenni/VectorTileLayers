...
{
    public class MGLVectorTileLayer : BaseLayer, IAsyncDataFetcher, IDisposable
    {
        ...
        public MGLVectorTileLayer(IEnumerable<IVectorTileStyle> vectorStyles, ITileSource tileSource, int minTiles = 200, int maxTiles = 300,
