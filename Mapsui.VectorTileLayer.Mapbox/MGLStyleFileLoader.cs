...
namespace Mapsui.VectorTileLayer.MapboxGL
{
    ...
    /// </summary>
    public static class MGLStyleFileLoader
    {
        ...
        private static ILayer CreateVectorTileLayer(JsonStyleFile jsonStyle, string name, JsonSource source, MGLSpriteAtlas spriteAtlas)
        {
            ...
            var vectorTileLayer = new MGLVectorTileLayer(vectorStyleLayers, tileSource);
        ...
        private static List<MGLVectorTileStyle> ExtractStyles(string sourceName, IEnumerable<JsonStyleLayer> jsonStyleLayers, MGLSpriteAtlas spriteAtlas)
        {
            var styleLayers = new List<MGLVectorTileStyle>();
            ...
            foreach (var jsonStyleLayer in jsonStyleLayers)
            {
                ...
                MGLVectorTileStyle styleLayer = new MGLVectorTileStyle
                {
